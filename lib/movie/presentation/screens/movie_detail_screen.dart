...
import 'package:movies/core/utils/dummy_detail.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<MovieDetailBloc>()
        ...
        ..add(GetMovieRecomendedEvent( id)),
      child: Scaffold(
...
class MovieDetailContent extends StatelessWidget {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                (state.movieDetail!.voteAaverage / 2)
                                    .toStringAsFixed(1),
                                style: const TextStyle(
                                  fontSize: 16.0,
                                  fontWeight: FontWeight.w500,
                              ...
                              const SizedBox(width: 4.0),
                              Text(
                                '(${state.movieDetail!.voteAaverage})',
                                style: const TextStyle(
                                  fontSize: 1.0,
                                  fontWeight: FontWeight.w500,
                                  letterSpacing: 1.2,
                      ...
                      const SizedBox(height: 8.0),
                      Text(
                        'Genres: ${_showGenres(state.movieDetail!.genre)}',
                        style: const TextStyle(
                          color: Colors.white70,
                          fontSize: 12.0,
                          fontWeight: FontWeight.w500,
  ...
  Widget _showRecommendations() {
    return BlocBuilder<MovieDetailBloc, MovieDetailState>(
  builder: (context, state) {
    switch(state.movieRecommendatinState) {
      case RequestState.loading:
        return SizedBox(
            height: 400.0,
            child: Center(child: CircularProgressIndicator()));
